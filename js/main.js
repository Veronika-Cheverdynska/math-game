  ...
  document.getElementById("variant" + i).onclick = function() {
    ...
    if(playing == true) {//we are playing
      if(this.innerHTML == correctAnswer) {//the answer is correct
        ...
        document.getElementById("score-value").innerHTML = score; //adding value of score
		if(score >= 0){
		document.getElementById("score-value").style.color = "#00b900"; //change color of the score value to green			
		}
		...
		document.getElementById("score-value").innerHTML = score; //adding value of score
		if(score < 0){
		document.getElementById("score-value").style.color = "#ff5640"; //change color of the score value to red			
		}
